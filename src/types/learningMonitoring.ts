export enum LearningMonitoringLabelsEnum {
  persisteDiandteDeSuasDificuldades = 'Persiste diante de sua dificuldades?',
  acompanhaAsLeiturasIndividualEColetiva = 'Acompanha as leituras individual e/coletiva?',
  realizaAtividadesEAcompanhanhaACorrecao = 'Realiza atividades e acompanha a correção?',
...
export enum LearningMonitoringValuesEnum {
  persisteDiandteDeSuasDificuldades = 'persisteDiandteDeSuasDificuldades',
  acompanhaAsLeiturasIndividualEColetiva = 'acompanhaAsLeiturasIndividualEColetiva',
...
export const learningMonitoringColumns = [
...
export const learningMonitoringValues = (item: any) => {
  return {
    [LearningMonitoringValuesEnum.persisteDiandteDeSuasDificuldades]: item[
      LearningMonitoringValuesEnum.persisteDiandteDeSuasDificuldades
    ]
      ? 'Sim'
      : 'Não',
    [LearningMonitoringValuesEnum.acompanhaAsLeiturasIndividualEColetiva]: item[
    ...
    [LearningMonitoringValuesEnum.relacionaseBemComOsOutros]: item[
    ...
    [LearningMonitoringValuesEnum.identificaAsConsoantes]: item[
      ...
      ? 'Sim'
      : 'Não',
    [LearningMonitoringValuesEnum.escreveSeuNome]: item[
    ...
    [LearningMonitoringValuesEnum.escreveNumerosPorExtenso]: item[
      ...
      ? 'Sim'
      : 'Não',
    [LearningMonitoringValuesEnum.escreveNumerosPorOrdem]: item[
